...
export const ENEMIES = {
  ...
  cultist: { id: "cultist", name: "Cultist", behavior: "caster", hp: 10, damage: [3, 5], accuracy: 77, defense: 0, xp: 15, gold: [4, 7], glyph: "C", range: 5 },
  orc_brute: { id: "orc_brute", name: "Orc Brute", behavior: "melee", hp: 20, damage: [4, 7], accuracy: 79, defense: 2, xp: 22, gold: [5, 9], glyph: "O" },
  gloomblade: { id: "gloomblade", name: "Gloomblade", behavior: "skirmisher", hp: 16, damage: [4, 6], accuracy: 86, defense: 1, evasion: 4, xp: 24, gold: [5, 9], glyph: "A" },
  dread_slime: { id: "dread_slime", name: "Dread Slime", behavior: "blocker", hp: 23, damage: [4, 5], accuracy: 76, defense: 2, xp: 25, gold: [5, 8], glyph: "D" },
  shaman: { id: "shaman", name: "Orc Shaman", behavior: "caster", hp: 16, damage: [4, 6], accuracy: 77, defense: 1, xp: 28, gold: [7, 11], glyph: "H", range: 6 },
  chort: { id: "chort", name: "Chort", behavior: "melee", hp: 26, damage: [6, 8], accuracy: 82, defense: 2, xp: 34, gold: [8, 12], glyph: "T" },
