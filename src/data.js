...
export const ENEMIES = {
  ...
  cultist: { id: "cultist", name: "Cultist", behavior: "caster", hp: 10, damage: [3, 5], accuracy: 85, defense: 0, xp: 15, gold: [6, 10], glyph: "C", range: 5 },
  ...
  shaman: { id: "shaman", name: "Orc Shaman", behavior: "caster", hp: 16, damage: [4, 6], accuracy: 84, defense: 1, xp: 28, gold: [10, 16], glyph: "H", range: 6 },
  chort: { id: "chort", name: "Chort", behavior: "melee", hp: 26, damage: [6, 8], accuracy: 82, defense: 2, xp: 34, gold: [12, 18], glyph: "T" },
  infernal_imp: { id: "infernal_imp", name: "Infernal Imp", behavior: "caster", hp: 18, damage: [4, 7], accuracy: 87, defense: 1, xp: 38, gold: [12, 18], glyph: "I", range: 6 },
