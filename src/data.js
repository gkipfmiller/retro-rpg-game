...
export const ITEMS = {
  ...
  legion_spear: { id: "legion_spear", name: "Legion Spear", category: "weapon", slot: "weapon", classBias: "warrior", damage: [6, 9], accuracy: 3, bonus: { defenseFlat: 1 }, value: 34 },
  butcher_cleaver: { id: "butcher_cleaver", name: "Butcher Cleaver", category: "weapon", slot: "weapon", classBias: "warrior", damage: [7, 10], accuracy: -3, bonus: { meleeDamagePct: 5 }, value: 40 },
  ...
  ember_rod: { id: "ember_rod", name: "Ember Rod", category: "weapon", slot: "weapon", classBias: "wizard", damage: [2, 4], magicPower: 3, bonus: { spellDamagePct: 5 }, value: 38 },
  moon_staff: { id: "moon_staff", name: "Moon Staff", category: "weapon", slot: "weapon", classBias: "wizard", damage: [2, 5], magicPower: 4, bonus: { maxManaFlat: 6 }, value: 44 },
  ...
  scout_leathers: { id: "scout_leathers", name: "Scout Leathers", category: "armor", slot: "armor", defense: 2, evasion: 2, value: 24 },
  chain_armor: { id: "chain_armor", name: "Chain Armor", category: "armor", slot: "armor", defense: 3, evasion: -1, value: 30 },
  iron_cuirass: { id: "iron_cuirass", name: "Iron Cuirass", category: "armor", slot: "armor", defense: 3, value: 26 },
  bastion_mail: { id: "bastion_mail", name: "Bastion Mail", category: "armor", slot: "armor", defense: 4, bonus: { maxHpFlat: 6 }, value: 46 },
  ...
  dusk_robe: { id: "dusk_robe", name: "Dusk Robe", category: "armor", slot: "armor", defense: 2, bonus: { maxManaFlat: 8 }, value: 28 },
  enchanted_robe: { id: "enchanted_robe", name: "Enchanted Robe", category: "armor", slot: "armor", defense: 1, bonus: { maxManaFlat: 5 }, value: 30 },
  runespun_robe: { id: "runespun_robe", name: "Runespun Robe", category: "armor", slot: "armor", defense: 2, bonus: { maxManaFlat: 10, spellAccuracyFlat: 4 }, value: 48 },
...
export const CHEST_TABLE = {
  ...
  rare: ["ring_of_precision", "amulet_of_vitality", "charm_of_focus", "greater_healing_potion", "greater_mana_potion", "scroll_of_escape", "arcane_shield_tome", "frost_shard_tome", "butcher_cleaver", "moon_staff", "bastion_mail", "runespun_robe"],
