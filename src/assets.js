...
const assetManifest = {
  ...
  items: {
    ...
    spark_charm: `${BASE}/flask_yellow.png`,
    ...
    warbrand_token: `${EXTRACTED}/ring_red.png`,
    mirror_sigil: `${EXTRACTED}/ring_blue.png`,
    charm_of_guarding: `${EXTRACTED}/amulet_dark.png`,
    chain_of_insight: `${EXTRACTED}/amulet_dark.png`,
    ...
    magic_missile_tome: `${EXTRACTED}/scroll_white.png`,
    arcane_shield_tome: `${EXTRACTED}/scroll_brown.png`,
    frost_shard_tome: `${EXTRACTED}/scroll_white.png`,
    blink_tome: `${EXTRACTED}/scroll_purple.png`,
    arcane_burst_tome: `${EXTRACTED}/scroll_orange.png`,
  },
};
